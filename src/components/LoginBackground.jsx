...
const LoginBackground = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < lightsCount; i++) {
      ...
      // Unique colors for lights - adjusting to teal
      const hue = Math.floor(Math.random() * 20) + 180; // Teal-ish hues
      light.style.background = `radial-gradient(circle, hsla(${hue}, 70%, 70%, 0.4) 0%, hsla(${hue}, 70%, 60%, 0) 70%)`;
